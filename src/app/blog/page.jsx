...
const featuredPost = {
  ...
  image: "/images/featured-gst.webp",
...
const posts = [
  ...
  },
  {
    ...
    date: "06 Jan 2026",
    category: "GST Updates",
    image: "/images/gst-registration.webp",
  ...
  },
  {
    ...
    image: "/images/roc-calendar.webp",
  ...
  return (
    <main className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-10 items-center bg-gray-50 border rounded-2xl p-6 shadow">
          ...
          {posts.map((post, i) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h4 className="font-bold text-lg mt-2 mb-2 text-[#0B1C2D]">
                  {post.title}
                </h4>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href={post.slug}
                    className="text-sm font-semibold text-[#0B1C2D] hover:text-[#D4AF37]"
                  >
                    Read More →
                  </Link>
                </div>
